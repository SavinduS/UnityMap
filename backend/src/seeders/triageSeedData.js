...
// Helper: generate dummy ObjectIds to keep upvotedBy.length === corroborationCount
const makeUpvotedBy = (count) => Array.from({ length: count }, () => new mongoose.Types.ObjectId());
